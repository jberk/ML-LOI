...
for df in df_list:
    ...
    log_model = Pipeline(steps=[
        ...
        ('classifier', SGDClassifier(loss='log_loss', max_iter=1000, class_weight="balanced"))
    ])
    ...
    joblib.dump(rf_model,f"logsgd_JDI_56d_{i}.joblib")
...
pooled_results.to_csv('JDI_LogSGD_MICE_56d.csv')
