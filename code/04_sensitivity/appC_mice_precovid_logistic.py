...
for df in df_list:
    ...
    for fold_number, (train_index, test_index) in enumerate(outer_cv.split(df_model, labels), start=1):
        ...
        grid_search = GridSearchCV(
            estimator=LogisticRegression(random_state=123, max_iter=100),
    ...
    final_model = LogisticRegression(random_state=123, max_iter=100, **final_params)
    ...
    #joblib.dump(final_model,f"log_56d_avgp_MICE_new_{i}.joblib")
    #print('Model saved!')
...
pooled_results.to_csv('Log_56d_MICE_Lim.csv')
