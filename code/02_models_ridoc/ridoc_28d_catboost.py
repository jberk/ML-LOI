...
print(df5['Long_stay'].value_counts())
...
for df in df_list:
   ...
   # }
    ...
    final_model = CatBoostClassifier(cat_features=cat_features)
    ...
    joblib.dump(final_model,f"cat_28d_avgp_MICE_new_{j}.joblib")
    print('Model saved!')
...
pooled_results.to_csv('Cat_NewMice_28d.csv')
